...
import hqx from './hqx.js'
import { perlin2, seed as noiseSeed } from './noiseGen.js'
...
export default class TerrainGenerator {
  ...
  /**
   * mayby store the tempcanvas and use it (as its smaller)
   * to generate the lines and just scale them up ! (should go alot faster)
   */
  magnify () {
  ...
  generate (seed) {
    ...
    return {canvas:finalCanvas, terr:this.terr}
  }
}
